 ...
 <!-- Main Sidebar Container -->
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="/resources/adminlte/dist/img/10.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">spring proj</span>
    </a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/hi/list" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>이승돌 목록</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/hi/regist" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>이승돌 등록</p>
                </a>
              </li>
